...
try:
        ...
        for slice in subscriber.get("slice", []):
            ...
            for session in slice.get("session", []):
                ...
                if apn_name in apn_template:
                    # Update session AMBR and QoS based on apn_config.json
    ...
    print("Note: slice.session.ambr fields have been updated to match apn_config.json, including unit: 3 for Mbps.")
