...
@Schema(name = "RequestedQosMonitoringParameter", description = "Indicates the requested QoS monitoring parameters to be measured.")
...
public class RequestedQosMonitoringParameter {
  ...
  public String toString() {
    ...
    sb.append("class RequestedQosMonitoringParameter {\n");
    sb.append("}");
    return sb.toString();
  }
