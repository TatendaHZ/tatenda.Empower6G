...
import autogen.scef.notification.api.model.InvalidParam;
...
public class ProblemDetails implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, title, status, detail, instance, cause, invalidParams, supportedFeatures, additionalProperties);
  }
