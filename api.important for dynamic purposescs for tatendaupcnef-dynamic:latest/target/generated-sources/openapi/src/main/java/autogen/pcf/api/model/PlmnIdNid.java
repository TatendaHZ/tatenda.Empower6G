...
public class PlmnIdNid implements Serializable {
  ...
  **/
   ...
   * @return the PlmnIdNid instance itself
   */
  public PlmnIdNid putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.mcc, plmnIdNid.mcc) &&
        ...
        Objects.equals(this.additionalProperties, plmnIdNid.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mcc, mnc, nid, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to PlmnIdNid
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PlmnIdNid.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PlmnIdNid is not found in the empty JSON string", PlmnIdNid.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PlmnIdNid.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PlmnIdNid.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PlmnIdNid' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PlmnIdNid> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PlmnIdNid.class));

       return (TypeAdapter<T>) new TypeAdapter<PlmnIdNid>() {
           @Override
           public void write(JsonWriter out, PlmnIdNid value) throws IOException {
           ...
           @Override
           public PlmnIdNid read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PlmnIdNid instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PlmnIdNid given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PlmnIdNid
  * @throws IOException if the JSON string is invalid with respect to PlmnIdNid
  */
  public static PlmnIdNid fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PlmnIdNid.class);
  }

 /**
  * Convert an instance of PlmnIdNid to an JSON string
  *
  * @return JSON string
  */
