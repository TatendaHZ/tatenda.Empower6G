...
import autogen.pcf.api.auth.Authentication;
import autogen.pcf.api.auth.HttpBasicAuth;
import autogen.pcf.api.auth.HttpBearerAuth;
import autogen.pcf.api.auth.ApiKeyAuth;
import autogen.pcf.api.auth.OAuth;
import autogen.pcf.api.auth.RetryingOAuth;
import autogen.pcf.api.auth.OAuthFlow;
...
public class ApiClient {
    ...
    private String basePath = "https://example.com/npcf-policyauthorization/v1";
    ...
    new ServerConfiguration(
      ...
      new HashMap<String, ServerVariable>() {{
        put("apiRoot", new ServerVariable(
          "apiRoot as defined in subclause 4.4 of 3GPP TS 29.501",
          "https://example.com",
          new HashSet<String>(
          )
        ));
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "{nrfApiRoot}/oauth2/token";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.2.0-alpha.2/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://example.com/npcf-policyauthorization/v1
     ...
     * @return a {@link autogen.pcf.api.ApiClient} object
     */
     ...
     * @throws autogen.pcf.api.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws autogen.pcf.api.ApiException If fail to serialize the given object
     */
     ...
     * @throws autogen.pcf.api.ApiException If fail to read file content from response and write to disk
     ...
     * @throws autogen.pcf.api.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws autogen.pcf.api.ApiException If the response has an unsuccessful status code or
     ...
     * @throws autogen.pcf.api.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws autogen.pcf.api.ApiException If fails to update the parameters
     */
     ...
     * @throws autogen.pcf.api.ApiException If fail to serialize the request body object into a string
     */
