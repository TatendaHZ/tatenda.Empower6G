...
public class TnapId implements Serializable {
  ...
  **/
   ...
   * @return the TnapId instance itself
   */
  public TnapId putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ssId, tnapId.ssId) &&
        ...
        Objects.equals(this.additionalProperties, tnapId.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to TnapId
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TnapId.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TnapId is not found in the empty JSON string", TnapId.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TnapId.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TnapId' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TnapId> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TnapId.class));

       return (TypeAdapter<T>) new TypeAdapter<TnapId>() {
           @Override
           public void write(JsonWriter out, TnapId value) throws IOException {
           ...
           @Override
           public TnapId read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TnapId instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TnapId given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TnapId
  * @throws IOException if the JSON string is invalid with respect to TnapId
  */
  public static TnapId fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TnapId.class);
  }

 /**
  * Convert an instance of TnapId to an JSON string
  *
  * @return JSON string
  */
