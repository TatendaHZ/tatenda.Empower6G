 ...
 */
@JsonAdapter(FlowStatus.Adapter.class)
public enum FlowStatus {
  ...
  public static class Adapter extends TypeAdapter<FlowStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final FlowStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FlowStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FlowStatus.fromValue(value);
    }
  }
}
