...
public class QodConfig {
  ...
  @Value("${qod.qos.references.qos-a}")
  private String qosReferenceQosA;
  @Value("${qod.qos.references.qos-b}")
  private String qosReferenceQosB;
  @Value("${qod.qos.references.qos-c}")
  private String qosReferenceQosC;
  @Value("${qod.qos.references.qos-d}")
  private String qosReferenceQosD;
  @Value("${qod.qos.references.qos-f}")
  private String qosReferenceQosF;
  @Value("${qod.qos.references.qos-g}")
  private String qosReferenceQosG;
  @Value("${qod.qos.references.qos-h}")
  private String qosReferenceQosH;
  @Value("${qod.qos.references.qos-i}")
  private String qosReferenceQosI;
  @Value("${qod.qos.references.qos-j}")
  private String qosReferenceQosJ;
  @Value("${qod.qos.references.qos-k}")
  private String qosReferenceQosK;
  @Value("${qod.qos.references.qos-n}")
  private String qosReferenceQosN;
  @Value("${qod.qos.references.qos-o}")
  private String qosReferenceQosO;
  @Value("${qod.qos.references.qos-p}")
  private String qosReferenceQosP;
  @Value("${qod.qos.references.qos-q}")
  private String qosReferenceQosQ;
  @Value("${qod.qos.references.qos-r}")
  private String qosReferenceQosR;
  @Value("${qod.qos.references.qos-t}")
  private String qosReferenceQosT;
